...
\newcounter{PaperLetterEletterReport}
...
% 6:electronicsletter
% 7:technicalreport
\setcounter{PaperLetterEletterReport}{7} 

%% 1. 「論文」
\ifthenelse{\value{PaperLetterEletterReport} < 5}{%
...
}{\ifthenelse{\value{PaperLetterEletterReport} = 6}{%
%% 3. 「レター（C分冊）」
%\usepackage[dvips]{graphicx}
%\usepackage[dvipdfmx]{graphicx,xcolor}
\usepackage[T1]{fontenc}
